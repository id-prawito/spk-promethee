            ...
            <div class="card card-primary">
                <div class="card-header">
                    <div class="col">
                        ...
                        OVO merupakan aplikasi smart yang memberikan Anda kesempatan lebih besar mengumpulkan poin di banyak tempat. Anda bisa menggunakan OVO untuk bertransaksi di semua merchant bertanda OVO Accepted Here dan mengumpulkan serta menggunakan OVO Points di merchant bertanda OVO Zone
                            <br>
                        </p>
                    </div>
                </div>
                    ...
                    <div id="accordion">
                        <div class="accordion">
                            <div class="accordion-header pt-4 pb-4" role="button" data-toggle="collapse" data-target="#panel-body-1" aria-expanded="true">
                                <h4>1. Bagaimana cara mengelola Data Alternatif pada Sistem Informasi ?</h4>
                            </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header pt-4 pb-4" role="button" data-toggle="collapse" data-target="#panel-body-8" aria-expanded="true">
                                <h4>2. Apa itu metode PROMETHEE ?</h4>
                            </div>
                            <div style="text-align: justify;" class="accordion-body collapse show" id="panel-body-8" data-parent="#accordion">
                                <p class="mb-0">Tipe Usual adalah tipe dasar, yang tidak memiliki nilai threshold atau kecenderungan dan tipe ini jarang digunakan. Secara matematis dapat dituiskan dalam notasi berikut:<br />
                                </p>
                                <br>
                                <img src="https://latex.codecogs.com/gif.latex?p(x)=\begin{cases} 0 \text{ \space \space \space \space } \forall x \leqslant 0,\\ 1 \text{ \space \space \space \space } \forall x > 0; \end{cases}" alt="" style="display: block; margin: auto;">
                        ...
                        <div class="accordion">
                            <div class="accordion-header pt-4 pb-4" role="button" data-toggle="collapse" data-target="#panel-body-2">
                                <h4>2. Bagaimana tahapan prosedur untuk proses pengolahan data PROMETHEE ?</h4>
                            </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header pt-4 pb-4" role="button" data-toggle="collapse" data-target="#panel-body-3">
                                <h4>3. Bagaimana cara mengelola Data Kriteria ?</h4>
                            </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header pt-4 pb-4" role="button" data-toggle="collapse" data-target="#panel-body-4">
                                <h4>4. Bagaimana cara mengelola Data Evaluasi Kriteria ?</h4>
                            </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header pt-4 pb-4" role="button" data-toggle="collapse" data-target="#panel-body-5">
                                <h4>5. Bagaimana cara mengelola Klasifikasi pada Sistem Informasi ?</h4>
                            </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header pt-4 pb-4" role="button" data-toggle="collapse" data-target="#panel-body-6">
                                <h4>6. Bagaimana cara mengelola Users pada Sistem Informasi ?</h4>
                            </div>
                        ...
                        <div class="accordion">
                            <div class="accordion-header pt-4 pb-4" role="button" data-toggle="collapse" data-target="#panel-body-7">
                                <h4>7. Bagaimana cara melihat hasil perhitungan data (rangking) ?</h4>
                            </div>
                            <div style="text-align: justify;" class="accordion-body collapse" id="panel-body-7" data-parent="#accordion">
                                <p class="mb-0">Tipe Linear Quasi juga mirip dengan tipe Linear yang acapkali digunakan dalam penilaian dari segi kuantitatif atau banyaknya jumlah. Tipe ini juga menggunakan threshold preference (n atau p) tetapi ditambahkan Satu threshold lagi yaitu indifference (m atau q).<br />
                                </p>
                                <br>
                                <img src="https://latex.codecogs.com/gif.latex?H(d) = 1 - exp \left \{ -\frac{d^{2}}{d\sigma^{2}} \right \}" alt="" style="display: block; margin: auto;">
